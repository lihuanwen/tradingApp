...
export class Control {
    ...
    static pushData(type, data) {
        $("#chart_loading").removeClass("activated");
        switch (type) {
            case 'Kline':
                // k线
                // Kline.instance.chartMgr.updateData("frame0.k0", Kline.instance.data.lines);
                if (Kline.instance.data.lines) {
                    Kline.instance.data.lines.push(data[0]);
                } else {
                    Kline.instance.data.lines = data
                }
                Kline.instance.chartMgr.updateData("frame0.k0", Kline.instance.data.lines);
                break;
            case 'Trade':
                // 成交
                Kline.instance.data.trades = data;
                KlineTrade.instance.pushTrades(data);
                KlineTrade.instance.klineTradeInit = true;
                break;
            case 'Depth':
                // 盘口
                Kline.instance.data.depths = data;
                KlineTrade.instance.updateDepth(data);
                break;
            default:
                Kline.instance.data = {
                    depths: [],
                ...
                ChartManager.instance.updateData("frame0.k0", null, true);
        }
        ...
        ChartManager.instance.setCurrentDataSource('frame0.k0', "" + '.' + 900000);
